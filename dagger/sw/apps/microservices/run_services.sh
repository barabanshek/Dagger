...
./apps/microservices/check_in_service/check_in_service 1 1 2>&1 | tee check_in_service.log &
CHECH_IN_SERVICE_PID=$!

./apps/microservices/flight_service/flight_service 1 1 2>&1 | tee flight_service.log &
FLIGHT_SERVICE_PID=$!

./apps/microservices/baggage_service/baggage_service 1 2>&1 | tee baggage_service.log&
BAGGAGE_SERVICE_PID=$!

./apps/microservices/passport_service/passport_service 1 1 2>&1 | tee passport_service.log&
